...
TOPICS = {
    "technology": {
        "nouns": [
            "algorithm", "software", "hardware", "database", "network", "server",
            "computer", "system", "program", "application", "interface", "protocol",
            "framework", "platform", "architecture", "infrastructure", "cloud",
            "security", "encryption", "authentication", "api", "microservice",
            "container", "kubernetes", "docker", "cache", "memory", "processor",
            "bandwidth", "latency", "throughput", "scalability", "reliability",
            "machine", "learning", "neural", "model", "training", "inference",
            "data", "analytics", "pipeline", "streaming", "batch", "realtime"
        ],
        "verbs": [
            "process", "compute", "analyze", "optimize", "implement", "deploy",
            "scale", "monitor", "debug", "test", "integrate", "migrate",
            "configure", "automate", "parallelize", "distribute", "synchronize",
            "cache", "compress", "encrypt", "authenticate", "validate"
        ],
        "adjectives": [
            "distributed", "parallel", "concurrent", "asynchronous", "scalable",
            "reliable", "efficient", "robust", "secure", "optimized", "automated",
            "real-time", "high-performance", "fault-tolerant", "cloud-native"
        ]
    },
    "science": {
        "nouns": [
            "research", "experiment", "hypothesis", "theory", "observation",
            "analysis", "methodology", "sample", "variable", "correlation",
            "causation", "phenomenon", "measurement", "instrument", "laboratory",
            "study", "findings", "results", "conclusion", "evidence", "data",
            "statistics", "probability", "distribution", "variance", "deviation",
            "particle", "molecule", "atom", "cell", "organism", "species",
            "genome", "protein", "enzyme", "reaction", "compound", "element"
        ],
        "verbs": [
            "observe", "measure", "analyze", "hypothesize", "experiment",
            "validate", "replicate", "synthesize", "isolate", "identify",
            "classify", "quantify", "correlate", "predict", "simulate"
        ],
        "adjectives": [
            "empirical", "theoretical", "experimental", "quantitative",
            "qualitative", "statistical", "significant", "controlled",
            "reproducible", "systematic", "rigorous", "peer-reviewed"
        ]
    },
    "business": {
        "nouns": [
            "market", "customer", "revenue", "profit", "growth", "strategy",
            "investment", "portfolio", "stakeholder", "shareholder", "dividend",
            "acquisition", "merger", "partnership", "venture", "startup",
            "enterprise", "corporation", "subsidiary", "franchise", "brand",
            "product", "service", "pricing", "margin", "cost", "budget",
            "forecast", "projection", "quarter", "fiscal", "annual", "report"
        ],
        "verbs": [
            "invest", "acquire", "merge", "diversify", "expand", "launch",
            "market", "sell", "purchase", "negotiate", "contract", "outsource",
            "streamline", "restructure", "monetize", "capitalize", "leverage"
        ],
        "adjectives": [
            "profitable", "sustainable", "competitive", "strategic", "fiscal",
            "quarterly", "annual", "global", "domestic", "emerging", "mature",
            "disruptive", "innovative", "scalable", "diversified"
        ]
    },
    "health": {
        "nouns": [
            ...
            "infection", "inflammation", "immunity", "vaccine", "antibody",
            "hospital", "clinic", "physician", "surgeon", "nurse", "specialist",
            "procedure", "surgery", "recovery", "rehabilitation", "prevention",
            "nutrition", "exercise", "lifestyle", "wellness", "mental", "physical"
        ],
        "verbs": [
            "diagnose", "treat", "prescribe", "administer", "monitor",
            "examine", "evaluate", "assess", "recommend", "prevent",
            "rehabilitate", "recover", "heal", "immunize", "vaccinate"
        ],
        "adjectives": [
            "clinical", "medical", "therapeutic", "preventive", "chronic",
            "acute", "infectious", "genetic", "hereditary", "symptomatic",
            "asymptomatic", "benign", "malignant", "invasive", "non-invasive"
        ]
    },
    "general": {
        "nouns": [
        ...
        "adjectives": [
            ...
            "bad", "same", "able", "local", "sure", "free", "best", "better"
        ]
    }
}
...
def generate_sentence(topic_vocab: Dict[str, List[str]], length: int = None) -> str:
...
def generate_paragraph(topic_vocab: Dict[str, List[str]], sentences: int = None) -> str:
...
def generate_document(
    ...
    title_words = [
        ...
        random.choice(["Analysis", "Study", "Overview", "Guide", "Review",
                       "Introduction", "Exploration", "Investigation"])
    ]
...
def save_corpus(documents: List[Document], filepath: str):
    ...
    data = {
        "metadata": {
            ...
            "topics": list(set(d.topic for d in documents))
        },
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate synthetic document corpus for TF-IDF testing"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output", type=str, default="corpus.json",
    ...
    parser.add_argument(
        ...
        help="Maximum words per document (default: 2000)"
    )
